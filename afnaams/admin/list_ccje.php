...
<title>All Non-Academic Awards CCJE</title>
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-header">
                    <b>All Non-Academic Awards CCJE </b>
                </div>
                <div class="card-body table-responsive">
                    <table id="myTable" class="table table-bordered table-sm table-striped nowrap compact">
                        ...
                        <tbody>
                            <?php
                            $i = 1;
                            $non_academic_awards = $conn->query("SELECT * FROM non_academic_awards WHERE status = '1'AND department = 'CCJE' ORDER BY id ASC");
